...
import qr_reader_logic.google.zxing.client.android_modified.camera.open.OpenCameraManager;
...
public final class CameraManager {
    ...
    public static int minFrameWidth;
    public static int minFrameHeight;
    ...
    /**
     * Convenience method for {com.google.zxing.client.android.BarcodeFragment}
     */
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int height = findDesiredDimensionInRange(screenResolution.y, minFrameHeight, MAX_FRAME_HEIGHT);
